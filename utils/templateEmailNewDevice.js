...
const templateEmailNewDevice = (email, bodyContent, timestamp, ipInfo, userAgent) => {
    ...
    * {
    ...
    <table id="u_content_heading_1" style="font-family:arial,helvetica,sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
      ...
      <!--[if mso]><table width="100%"><tr><td><![endif]-->
        <h1 class="v-text-align v-font-size" style="margin: 0px; color: #ff715e; line-height: 140%; text-align: left; word-wrap: break-word; font-family: 'Montserrat',sans-serif; font-size: 22px; font-weight: 700;"><span><span><span><span><span><span><span><span>[Matrix] Phát hiện đăng nhập trên thiết bị mới</span></span></span></span></span></span></span></span></h1>
    ...
    <table id="u_content_text_2" style="font-family:arial,helvetica,sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
      ...
      <div class="v-text-align v-font-size" style="font-size: 14px; line-height: 140%; text-align: left; word-wrap: break-word;">
        <p style="line-height: 140%;"><strong>Thông tin của phiên đăng nhập: </strong></p>
    <p style="line-height: 140%;"> </p>
    <p style="line-height: 140%;"><strong>Thời gian:</strong> ${timestamp}</p>
    <p style="line-height: 140%;"> </p>
    <p style="line-height: 140%;"><strong>Thông tin IP:</strong></p>
    <p style="line-height: 140%;">- ip: ${ipInfo.ip}</p>
    <p style="line-height: 140%;">- city: ${ipInfo.city}</p>
    <p style="line-height: 140%;">- region: ${ipInfo.region}</p>
    <p style="line-height: 140%;">- country: ${ipInfo.country}</p>
    <p style="line-height: 140%;">- loc: ${ipInfo.loc}</p>
    <p style="line-height: 140%;">- org: ${ipInfo.org}</p>
    <p style="line-height: 140%;">- postal: ${ipInfo.postal}</p>
    <p style="line-height: 140%;">- timezone: ${ipInfo.timezone}</p>
    <p style="line-height: 140%;"> </p>
    <p style="line-height: 140%;"><strong>User Agent:</strong></p>
    <p style="line-height: 140%;">${userAgent}</p>
    <p style="line-height: 140%;"> </p>
    <p style="line-height: 140%;"><strong>Lưu ý: </strong></p>
    <p style="line-height: 140%;">Nếu phiên đăng nhập này là của bạn hoặc bạn biết thông tin đăng nhập này, vui lòng bỏ qua email.</p>
    <p style="line-height: 140%;"> </p>
      </div>
  ...
  module.exports = templateEmailNewDevice